...
- **generated_from**: pyproject.toml, testql(2), app.doql.less, goal.yaml, .env.example, src(12 mod), project/(5 analysis files)
...
# code2llm | 23f 8259L | python:14,yaml:4,json:1,txt:1,shell:1,javascript:1,toml:1 | 2026-06-01
# generated in 0.01s
# CC̅=5.2 | critical:7/184 | dups:0 | cycles:0
...
HEALTH[7]:
  ...
  🟡 CC    organize_html CC=24 (limit:15)
  🟡 CC    build_http_llm_context CC=29 (limit:15)
...
PIPELINES[58]:
  ...
  [19] Src [enforce_deletes_on_option_previews]: enforce_deletes_on_option_previews → apply_spatial_deletes_to_html → _delete_match_keys
      PURITY: 100% pure
  [20] Src [generate_patch_suggestions]: generate_patch_suggestions
      PURITY: 100% pure
  [21] Src [_normalize_scopes]: _normalize_scopes
      PURITY: 100% pure
  [22] Src [_build_user_prompt]: _build_user_prompt
      PURITY: 100% pure
  [23] Src [_parse_choice]: _parse_choice
      PURITY: 100% pure
  [24] Src [_choice_content]: _choice_content
      PURITY: 100% pure
  [25] Src [_default_completion]: _default_completion
      PURITY: 100% pure
  [26] Src [connect]: connect → _connectSSE → apply → cb
      PURITY: 100% pure
  [27] Src [payload]: payload → apply → cb
      PURITY: 100% pure
  [28] Src [onPatch]: onPatch
      PURITY: 100% pure
  [29] Src [dslClean]: dslClean
      PURITY: 100% pure
  [30] Src [addMatch]: addMatch
      PURITY: 100% pure
  [31] Src [replaceMatch]: replaceMatch
      PURITY: 100% pure
  [32] Src [styleMatch]: styleMatch
      PURITY: 100% pure
  [33] Src [removeMatch]: removeMatch → cb
      PURITY: 100% pure
  [34] Src [html]: html
      PURITY: 100% pure
  ...
  [36] Src [css]: css
      PURITY: 100% pure
  [37] Src [styleEl]: styleEl
      PURITY: 100% pure
  [38] Src [sendPatchRequest]: sendPatchRequest
      PURITY: 100% pure
  [39] Src [on_patch]: on_patch
      PURITY: 100% pure
  [40] Src [start]: start
      PURITY: 100% pure
  [41] Src [_run_event_loop]: _run_event_loop
      PURITY: 100% pure
  [42] Src [_connect_and_listen]: _connect_and_listen
      PURITY: 100% pure
  [43] Src [_trigger_listeners]: _trigger_listeners → cb
      PURITY: 100% pure
  [44] Src [send_patch]: send_patch
      PURITY: 100% pure
  [45] Src [organize_html_project_dir]: organize_html_project_dir → organize_html → _extract_inline_styles
      PURITY: 100% pure
  [46] Src [organize_html_project]: organize_html_project → organize_html → _extract_inline_styles
      PURITY: 100% pure
  [47] Src [organize_result_manifest]: organize_result_manifest
      PURITY: 100% pure
  [48] Src [extract_visual_css]: extract_visual_css → extract_inline_css
      PURITY: 100% pure
  [49] Src [__init__]: __init__
      PURITY: 100% pure
  [50] Src [_keep_attr]: _keep_attr
      PURITY: 100% pure

LAYERS:
  repatch/                        CC̄=5.6    ←in:0  →out:0
  │ !! marked_context             696L  0C   32m  CC=17     ←3
  │ !! scope                      647L  0C   22m  CC=29     ←2
  │ !! web_preprocess             459L  1C   21m  CC=29     ←1
  │ web_fetch                  370L  2C   15m  CC=7      ←0
  │ dom_patch                  315L  0C   19m  CC=12     ←0
  │ !! organize_html              287L  1C   12m  CC=24     ←0
  │ !! ui_patch                   267L  0C   10m  CC=25     ←0
  │ options                    140L  0C    5m  CC=10     ←0
  │ __init__                   139L  0C    0m  CC=0.0    ←0
...
# redup/duplication | 1 groups | 13f 3735L | 2026-06-01
...
HOTSPOTS[1] (files with most duplication):
  repatch/marked_context.py  dup=24L  groups=1  frags=2  (0.6%)
...
# code2llm/evolution | 184 func | 14f | 2026-06-01
# generated in 0.00s
...
NEXT[10] (ranked by impact):
  ...
  [5] !  SPLIT-FUNC      organize_html  CC=24  fan=22
      WHY: CC=24 exceeds 15
      EFFORT: ~1h  IMPACT: 528

  [6] !! SPLIT-FUNC      apply_ui_patch_options  CC=25  fan=21
      WHY: CC=25 exceeds 15
      EFFORT: ~1h  IMPACT: 525

  [7] !! SPLIT-FUNC      build_http_llm_context  CC=29  fan=11
      WHY: CC=29 exceeds 15
      EFFORT: ~1h  IMPACT: 319

  [8] !  SPLIT-FUNC      resolve_marked_selectors  CC=16  fan=15
      WHY: CC=16 exceeds 15
      EFFORT: ~1h  IMPACT: 240

  [9] !  SPLIT-FUNC      _find_marked_subtrees  CC=17  fan=13
